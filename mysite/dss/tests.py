...
class McdaTest(TestCase):
    ...
    thresholds = {
        "Ni concentration (%)": {"q": 0.0, "p": 2.0},
        "Li concentration (%)": {"q": 0.0, "p": 0.01},
        "Mg concentration (%)": {"q": 0.0, "p": 0.05},
        "Ti concentration (%)": {"q": 0.0, "p": 0.05},
        "Cu concentration (%)": {"q": 0.0, "p": 1.0},
        "Operator": {"q": 0.0, "p": 1.0},
        "Recycled input (kg/kg)": {"q": 0.0, "p": 0.10},
        "Waste output (kg/kg)": {"q": 0.0, "p": 0.05},
        "Climate change (GWP100)": {"q": 0.0, "p": 5.0},
        "Acidification (AE)": {"q": 0.0, "p": 0.05},
        "Eutrophication Freshwater (P)": {"q": 0.0, "p": 0.003},
        "Particulate Matter (human health)": {"q": 0.0, "p": 0.0000005},
        "LandUse (soil quality index)": {"q": 0.0, "p": 20.0},
        "WaterUse (m³ world eq deprived)": {"q": 0.0, "p": 3.0},
        "Ionising radiation (kBq U-235 eq)": {"q": 0.0, "p": 0.2},
    }
