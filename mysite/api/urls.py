...
router.register(r'product', views.ProductViewSet, basename='ProductItem')
...
router.register(r'replacedcomponents', views.ReplacedComponentsViewSet, basename='ReplacedComponent')
